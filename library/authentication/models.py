...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    """
    first_name = models.CharField(max_length=20, blank=True, null=None)
    last_name = models.CharField(max_length=20, blank=True, null=None)
    middle_name = models.CharField(max_length=20, blank=True, null=None)
